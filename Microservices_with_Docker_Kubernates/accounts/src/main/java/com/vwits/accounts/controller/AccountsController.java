...
import com.vwits.accounts.dto.AccountsContactInfoDto;
...
public class AccountsController {
    ...
    @Operation(
            ...
            description = "Get Build Information that deployed into account Microservice"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
    ...
    @Operation(
            ...
            description = "Get Contact Information that deployed into account Microservice"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
